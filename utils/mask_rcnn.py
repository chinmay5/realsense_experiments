...
class MaskRCNN:
    def __init__(self):
        # Loading Mask RCNN
        self.net = cv2.dnn.readNetFromTensorflow(os.path.join(PROJECT_ROOT_DIR, 'utils', 'dnn', 'frozen_inference_graph_coco.pb'),
                                                 os.path.join(PROJECT_ROOT_DIR, 'utils', 'dnn','mask_rcnn_inception_v2_coco_2018_01_28.pbtxt'))
        ...
        self.classes = []
        with open(os.path.join(PROJECT_ROOT_DIR, 'utils', 'dnn','classes.txt'), "r") as file_object:
